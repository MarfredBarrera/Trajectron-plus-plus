...
cars = [plt.imread(os.path.join(_ICON_DIR, 'Car TOP_VIEW 375397.png')),
        plt.imread(os.path.join(_ICON_DIR, 'Car TOP_VIEW F05F78.png')),
        plt.imread(os.path.join(_ICON_DIR, 'Car TOP_VIEW 80CBE5.png')),
        plt.imread(os.path.join(_ICON_DIR, 'Car TOP_VIEW ABCB51.png')),
        plt.imread(os.path.join(_ICON_DIR, 'Car TOP_VIEW C8B0B0.png'))]

robot = plt.imread(os.path.join(_ICON_DIR, 'Car TOP_VIEW ROBOT.png'))
